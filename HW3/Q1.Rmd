...
points(x, var_natural, col = 'blue', pch = 16)
...
legend(x=0.3, y=0.7, legend = c('Global Linear', 'Global Cubic Polynomial', 'Global Spline - 2 knots', 'Natural Cubic Spline - 6 knots'),col = c('orange', 'red', 'green', 'blue'), lty = 1)
